...
const CourseDetails = () => {
  return (
    <div className="">
      <div className="overflow-hidden bg-[#ffffff] font-inter sm:rounded-tl-3xl rounded-none sm:rounded-bl-3xl h-full w-full">
          ...
          <div className="flex pl-[32px] z-[100px] w-full mt-5 ">
            <Link to={"/"}>
              <button className="text-lg h-full px-[16px] py-2 bg-gray-100 rounded-xl text-extrabold">
                <h2 className="text-[16px] font-bold">{"<--"}  Back</h2>
              </button>
            </Link>
