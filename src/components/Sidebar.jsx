...
const Sidebar = () => {
  return (
    <div className=" text-white overflow-y overflow-x-hidden h-screen hidden tablet:block px-[24px] pb-[16px] bg-[#21222A]">
      <div className=" h-screen relative mr-5 top-0 w-[136px] bg-[#21222A]  md:flex">
        <div className="w-full h-full text-center items-center justify-between">
          ...
          {/* <div className=" fixed align-bottom place-items-baseline bg-[#21222A] justify-center text-center max-w-full items-center"> */}
          <div className="fixed w-[136px] mb-3 bg-[#21222A] items-center justify-center text-center">
            {/* </div> */}
